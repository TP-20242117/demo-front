<template>
  <div>
    ...
    <div v-else-if="!selectedTask" class="screen task-selection">
      ...
      <div class="button-container">
        <button @click="selectTask('stroop')" :disabled="tasksCompleted.stroop">Stroop Task</button>
        <button @click="selectTask('cpt')" :disabled="tasksCompleted.cpt">Continuous Performance Task</button>
        <button @click="selectTask('stop')" :disabled="tasksCompleted.stop">Stop Signal Task</button>
      </div>
    </div>
    ...
    <div v-else class="task-container">
      ...
      <ContinuousPerformanceTask v-if="selectedTask === 'cpt'" @backToTaskSelection="handleTaskCompleted('cpt')" />
      <StopSignalTask v-if="selectedTask === 'stop'" @backToTaskSelection="handleTaskCompleted('stop')" />
    </div>
  </div>
</template>
